...
\begin{equation}
    ...
    \label{eq:omega}
\end{equation}
\smc{In order to be consistent with previous work, I have taken away the prime and added a 0 to the omega's. Please update the figures accordingly and while you're at it, convert the figures to pdf's.}
